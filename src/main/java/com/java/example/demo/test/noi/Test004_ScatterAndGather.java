...
public class Test004_ScatterAndGather {
	...
	public void ScatterAndGather() throws IOException {
		RandomAccessFile fos=new RandomAccessFile("src/com/example/test/Resouce/1.txt","rw");
		...
		//聚集写入：Gather	
		RandomAccessFile fos1=new RandomAccessFile("src/com/example/test/Resouce/2.txt","rw");
